...
Section PBFThas_new_view.
  ...
  Proof.
    ...
    - pose proof (IHs1 x1 v x4 x0) as q; autodimp q hyp; clear IHs1.
      unfold has_nv, has_new_view in *; smash_pbft.
  Qed.
  ...
  Proof.
    ...
    - unfold has_nv, has_new_view in *; smash_pbft; repndors; tcsp;[|].
      ...
      + pose proof (IHs1 (vce_view a) vc x4 x1 x2) as q; smash_pbft.

      + pose proof (IHs1 (vce_view a) vc x4 x1 x2) as q; smash_pbft;
          pose proof (IHs1 v vc x4 x1 x2) as w; smash_pbft.
  Qed.
