...
Section PBFTexecute4.
  ...
  Proof.
    ...
    - destruct a, b; simpl in *; ginv.
      ...
      + match goal with
        ...
        exrepnd.
        subst; simpl in *.
        unfold mk_auth_reply, mk_reply in *; ginv.
  ...
  Proof.
    ...
    - assert False; tcsp.
      ...
      + destruct a, b; simpl in *; ginv.
        unfold reply2request in *; simpl in *; smash_pbft; try omega;
          unfold  mk_auth_reply, mk_reply in *; ginv; smash_pbft; try omega.
  ...
  Proof.
    ...
    - smash_pbft.
      ...
      exists (x2 :: x6) reps2 x8 x5; simpl; dands; auto.
  Qed.
  ...
  Proof.
    introv r2r.
    unfold reply2request in r2r; smash_pbft;
      unfold mk_auth_reply, mk_reply in *; ginv; smash_pbft.
  Qed.
  ...
  Proof.
...

    {
      ...
      - exists reps1 smst' lastr' e0 e2.
        unfold mk_auth_reply, mk_reply in *; ginv; dands; auto;[|].
  ...
  Proof.
    ...
    inversion inmsgs1; subst; simpl in *; GC.
  ...
  Proof.
    ...
    eapply in_output_system_on_event_ldata in inout; eauto.

    unfold PBFTsys in inout.
    try rewrite eqloce in inout.
