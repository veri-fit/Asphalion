...
Section MinBFTcount_gen2_debug.
  ...
  Lemma cexec_increases_debug :
    forall a
      ...
      -> trigger e = trigger_info_data (MinBFT_debug a)
  ...
  Proof.
    ...
    remember (M_run_ls_on_input (MinBFTlocalSys_newP s s1 subs1) (msg_comp_name 0) (MinBFT_debug a)) as run.
