...
Section MinBFTcount_gen5_accept.
  ...
  Lemma accepted_counter_if_received_UI_primary_accept :
    forall R s x subs s' subs' out r i l,
      ...
      -> M_run_ls_on_input (MinBFTlocalSys_newP R s subs) (msg_comp_name 0) (MinBFT_accept x)
