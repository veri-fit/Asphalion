...
Section MinBFTcount_gen4_commit.
  ...
  Lemma M_run_ls_on_this_one_event_minbft_preserves_cond_LOGname_commit :
    forall c {eo : EventOrdering} (e : Event) R s s' subs subs',
