...
set style line 1 lt 1 pi 100  pt 1 linecolor rgb "green"
set style line 2 lt 1 pi 100  pt 2 linecolor rgb "red"
set style line 3 lt 1 pi 100  pt 7 linecolor rgb "red"

set style line 4 lt 1 pi 100  pt 4 linecolor rgb "green"
...
plot "pbft_avg_0_3_1_100000.dat" using 1:2 title "verif. PBFT f=3" w linespoint ls 3, \
     "pbft_avg_0_2_1_100000.dat" using 1:2 title "verif. PBFT f=2" w linespoint ls 2, \
     "pbft_avg_0_1_1_100000.dat" using 1:2 title "verif. PBFT f=1" w linespoint ls 5, \
     "minbft_avg_0_3_1_100000.dat" using 1:2 title "verif. MinBFT f=3" w linespoint ls 6, \
     "minbft_avg_0_2_1_100000.dat" using 1:2 title "verif. MinBFT f=2" w linespoint ls 1, \
     "minbft_avg_0_1_1_100000.dat" using 1:2 title "verif. MinBFT f=1" w linespoint ls 4
