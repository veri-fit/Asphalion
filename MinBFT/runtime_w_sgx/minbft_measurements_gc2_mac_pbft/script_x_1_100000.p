...
set output 'pbft_mac_vs_minbft.svg'
...
plot "minbft_avg_0_1_1_100000.dat" using 1:2 title "verif. MinBFT f=1" w linespoint ls 3, \
     "pbft_avg_0_1_1_1000000.dat" using 1:2 title "verif. PBFT (MAC) f=1" w linespoint ls 6
