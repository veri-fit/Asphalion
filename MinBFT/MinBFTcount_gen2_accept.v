...
Section MinBFTcount_gen2_accept.
  ...
  Lemma cexec_increases_accept :
    forall a
      ...
      -> trigger e = trigger_info_data (MinBFT_accept a)
  ...
  Proof.
    ...
    remember (M_run_ls_on_input (MinBFTlocalSys_newP s s1 subs1) (msg_comp_name 0) (MinBFT_accept a)) as run.
