...
(*    \/ checkpoint_in_view_change cp (view_change_state s)*)
  ...
  (* cp is part of checkpoint log, not part of the stable checkpoint *)
  ...
  (* checkpoint in state <-> checkpoint in log *)
  ...
  Proof.
    ...
    (* I need this part !!!!!!!!*)
    {
      ...
      apply checkpoint_in_state_as_checkpoint_in_others in cpinlog. (* checkpoint is in the log *)
      eapply trace_back_checkpoint_in_log in cpinlog; [|eauto]; auto. (* checkpoint is either received or generated *)
...
*)
        ...
        applydup localLe_implies_loc in cpinlog1. (* why do we need this? *)
